                        ...
                        <div className="row align-items-end mb-5 g-0 text-center border-bottom pb-5 mx-auto" style={{ maxWidth: '600px' }}>
                            {topThree[1] && (
                                <div className="col-4 px-2">
                                    <div className="mb-2"><Award className="text-secondary mx-auto" size={40} /></div>
                            ...
                            {topThree[0] && (
                                <div className="col-4 px-2">
                                    <div className="mb-2"><Trophy className="text-warning mx-auto" size={56} /></div>
                            ...
                            {topThree[2] && (
                                <div className="col-4 px-2">
                                    <div className="mb-2"><Award size={32} style={{ color: '#CD7F32' }} className="mx-auto" /></div>
