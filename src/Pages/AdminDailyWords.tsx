                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-end px-3">
                        ...
                        <div className="mt-4 mt-md-0">
                            <button onClick={() => { resetForm(); setShowForm(!showForm); }}
                                className="btn btn-dark fw-bold smallest ls-1 px-4 py-2 rounded-pill shadow-sm">
            ...
            <div className="container py-5" style={{ maxWidth: '1100px' }}>
                ...
                <div className="bg-white rounded-4 border shadow-sm p-4 mb-4 d-flex align-items-center gap-3">
                    <div className="d-flex align-items-center justify-content-center rounded-3"
                        ...
                        <i className="bi bi-book fs-4" style={{ color: '#D97706' }}></i>
                    </div>
                    <div>
                ...
                {loading ? (
                    <div className="text-center py-5">
                        ...
                        <p className="mt-3 ls-1 smallest fw-bold text-muted">LOADING WORDS...</p>
                    </div>
                ) : words.length === 0 ? (
                                    ...
                                    <div className="bg-white border rounded-4 shadow-sm p-4 h-100 dw-card">
                                        <div className="d-flex justify-content-between align-items-start mb-3">
                                            ...
                                            <div className="d-flex gap-2">
                                                <button onClick={() => handleEdit(w)} className="btn btn-sm btn-outline-dark rounded-pill px-3"
                                                    style={{ fontSize: 11 }}>
                                                    <i className="bi bi-pencil me-1"></i>Edit
                                                </button>
                                                <button onClick={() => handleDelete(w)} className="btn btn-sm btn-outline-danger rounded-pill px-3"
                                                    style={{ fontSize: 11 }}>
