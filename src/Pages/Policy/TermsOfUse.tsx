...
const TermsOfUse: React.FC = () => {
    const termsText = `
        ...
        Welcome to Chommie Language Companion. By accessing or using our website, mobile application, or any other services provided by Chommie Language Companion (collectively, the "Service"), you agree to be bound by these Terms of Use ("Terms"). If you do not agree to these Terms, do not use the Service. These Terms apply to all visitors, users, and others who access the Service.
        ...
        The Service and its original content (excluding Content provided by users), features, and functionality are and will remain the exclusive property of Chommie Language Companion and its licensors. The Service is protected by copyright, trademark, and other laws of both South Africa and foreign countries. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of Chommie Language Companion.
        ...
        10. Contact Us.
        If you have any questions about these Terms, please contact us at help@chommielanguage.com.
    `;
