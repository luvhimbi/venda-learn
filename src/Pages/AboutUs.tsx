                ...
                <div className="container py-5 text-center">
                    ...
                    >
                        ...
                        <h1 className="display-2 fw-black text-dark mb-4 ls-tight text-uppercase">
                            More Than Just <br />
                            <span className="bg-white px-3 border border-4 border-dark d-inline-block mt-2">Talking.</span>
                        </h1>
                        <p className="lead fw-bold text-dark mb-0 mx-auto" style={{ maxWidth: '700px' }}>
                ...
                <div className="container py-5">
                    <div className="row align-items-center g-5">
                        <div className="col-lg-6">
                            <h2 className="display-4 fw-black text-uppercase mb-4">The <span className="text-primary">Why</span></h2>
                            ...
                            <p className="fs-5 fw-medium text-muted mb-4 lh-base">
                                Most language apps feel like a classroom from the 90s. They're academic, they're slow, and let's be honest—they're <span className="text-dark fw-black">boring</span>. We wanted to change that.
                            </p>
                            <div className="p-4 bg-light border border-4 border-dark shadow-action">
                        ...
                        <div className="col-lg-6 text-center">
                            <div className="position-relative d-inline-block">
                                <div className="p-3 bg-white border border-4 border-dark shadow-action position-relative z-1">
            ...
            <section className="py-5 bg-light border-bottom border-4 border-dark">
                <div className="container py-5">
                    <div className="text-center mb-5">
                        ...
                        <p className="fw-bold text-muted">We replaced textbooks with quests and exams with games.</p>
                    </div>
                    <div className="row g-4">
                        <div className="col-md-4">
                            <div className="p-4 bg-white border border-4 border-dark shadow-action h-100">
                                <div className="bg-warning d-inline-block p-2 border border-2 border-dark mb-3">
                                    <span className="fw-black text-uppercase small">01. Gamified DNA</span>
                                </div>
                                <h4 className="fw-black text-uppercase">Play to Learn</h4>
                                <p className="fw-medium text-muted">From Word Bombs to Sentence Scrambles, our logic is simple: if you're having fun, you're learning faster.</p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="p-4 bg-white border border-4 border-dark shadow-action h-100">
                                ...
                                <p className="fw-medium text-muted">We don't just teach "The ball is red." We teach the slang, the rhythm, and the soul of Mzansi conversation.</p>
                            </div>
                        </div>
                        <div className="col-md-4">
                            <div className="p-4 bg-white border border-4 border-dark shadow-action h-100">
                                ...
                                <p className="fw-medium text-muted">Whether it's isiZulu, Tshivenda, or Sepedi—every language gets the premium treatment it deserves.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center g-5">
                        <div className="col-lg-5 order-lg-2">
                            ...
                            <div className="d-flex flex-column gap-2">
                                <span className="small fw-black text-uppercase text-muted">Get in touch:</span>
                                <a href="mailto:talifhaniluvhimbi@gmail.com" className="text-dark fw-black text-decoration-none fs-5 hover-yellow transition-all d-inline-block">
                                    talifhaniluvhimbi@gmail.com
                                </a>
                            </div>
                        </div>
                        <div className="col-lg-7 order-lg-1">
                            <div className="p-2 bg-dark border border-4 border-dark shadow-action">
                                <div className="bg-white p-4 border border-2 border-dark d-flex align-items-center justify-content-center" style={{ minHeight: '300px' }}>
                                    <div className="text-center">
                                        <div className="bg-warning d-inline-block p-4 border border-4 border-dark mb-3 shadow-action-sm">
                                            <i className="bi bi-code-slash fs-1"></i>
                                        </div>
                                        <h3 className="fw-black text-uppercase d-block mb-1">Talifhani Luvhimbi</h3>
                                        <span className="badge bg-dark rounded-0 border border-2 border-dark text-uppercase">Founder & Developer</span>
                                    </div>
                                </div>
                            </div>
                        </div>
