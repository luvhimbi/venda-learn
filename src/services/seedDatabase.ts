        ...
        microLessons: [
            {
                ...
                title: 'Basic Hello',
                slides: [
                    { venda: "Ndaa", english: "Hello (Male)", context: "Used by men and boys. It is polite to bow slightly or lower your eyes." },
                    { venda: "Aa", english: "Hello (Female)", context: "Used by women and girls. Usually accompanied by a soft hand clap." }
                ],
                questions: [
            ...
            },
            {
                ...
                title: 'Time of Day',
                slides: [
                    { venda: "Ndi matsheloni", english: "Good morning", context: "Used from sunrise until about 11:00 AM." },
                    { venda: "Ndi masiari", english: "Good afternoon", context: "used during the day from 13h00 pm" },
                    { venda: "Ndi madekwana", english: "Good night", context: "Used from 17h00 pm to show its night." }
                ],
                questions: [
                    ...
                    { id: 2, question: "Match the Venda greetings to their English meanings", pairs: [{ venda: "Ndaa", english: "Hello (Male)" }, { venda: "Aa", english: "Hello (Female)" }, { venda: "Ndi matsheloni", english: "Good morning" }], explanation: "Ndaa (male hello), Aa (female hello), Ndi matsheloni (good morning).", type: "match-pairs" },
                    { id: 3, vendaWord: "Ndi madekwana", question: "What did you hear?", options: ["Good morning", "Good afternoon", "Good night"], correctAnswer: "Good night", explanation: "'Ndi madekwana' means Good night, used from around 5 PM.", type: "listen-and-choose" }
                ]
            }
        ]
    },
        ...
        microLessons: [
            ...
            },
            {
                ...
                questions: [
                    ...
                    { id: 2, question: "Match the Venda numbers to their English values", pairs: [{ venda: "Nthihi", english: "One" }, { venda: "Raru", english: "Three" }, { venda: "Fumi", english: "Ten" }], explanation: "Nthihi=1, Raru=3, Fumi=10.", type: "match-pairs" }
                ]
            },
            {
                id: 'numbers__ml_2',
                ...
                questions: [
                    { id: 1, vendaWord: "Ṱhanu", question: "What number did you hear?", options: ["Three", "Five", "Ten"], correctAnswer: "Five", explanation: "'Ṱhanu' means Five (5) in Tshivenda.", type: "listen-and-choose" },
                    { id: 2, question: "Match the Venda numbers to their English values", pairs: [{ venda: "Fahuvhili", english: "Twenty" }, { venda: "Fahuraru", english: "Thirty" }, { venda: "Ḓana", english: "One Hundred" }], explanation: "Fahuvhili=20, Fahuraru=30, Ḓana=100.", type: "match-pairs" }
                ]
            }
        ]
    },
        ...
        microLessons: [
            {
                ...
                slides: [
                    { venda: "Mutukana", english: "Boy", context: "Refers to a young male child." },
                    { venda: "Musidzana", english: "Girl", context: "Refers to a young female child." },
                    { venda: "Murathu", english: "Younger sibling", context: "Used to refer to a sibling younger than you, regardless of gender." },
                    { venda: "khaladzi", english: "Sister", context: "Used to refer to your blood sister" },
                    { venda: "Muzwala", english: "cousin", context: "used to refer to your uncle kids." }
                ],
                questions: [
            ...
            },
            {
                ...
                title: 'Adults & Babies',
                slides: [
                    { venda: "lutshetshe", english: "new born baby", context: "A general term for a very young child or toddler." },
                    { venda: "nwana", english: "a young child", context: "A general term for a very young child or toddler." },
                    { venda: "Munna", english: "Man", context: "An adult male." },
                    { venda: "Musadzi", english: "Woman", context: "An adult female." }
                ],
                questions: [
                    ...
                    { id: 2, question: "Match the Venda identity words to English", pairs: [{ venda: "Mutukana", english: "Boy" }, { venda: "Musidzana", english: "Girl" }, { venda: "Munna", english: "Man" }, { venda: "Musadzi", english: "Woman" }], explanation: "Mutukana=Boy, Musidzana=Girl, Munna=Man, Musadzi=Woman.", type: "match-pairs" },
                    { id: 3, vendaWord: "Musadzi", question: "What did you hear?", options: ["Boy", "Woman", "Man"], correctAnswer: "Woman", explanation: "'Musadzi' means Woman in Tshivenda.", type: "listen-and-choose" }
                ]
            }
        ]
    },
        ...
        microLessons: [
            {
                ...
                slides: [
                    { venda: "Ndilo", english: "Plate", context: "A traditional wooden plate or a modern eating plate.", imageUrl: "https://cdn-icons-png.flaticon.com/512/662/662731.png" },
                    { venda: "Vhaisene", english: "Television", context: "The screen used for watching news and shows.", imageUrl: "https://cdn-icons-png.flaticon.com/512/716/716429.png" },
                    { venda: "Vothi", english: "Door", context: "The entrance to a room or house.", imageUrl: "https://cdn-icons-png.flaticon.com/512/59/59802.png" },
                    { venda: "Tshitepulu", english: "Table", context: "Where you eat or work.", imageUrl: "https://cdn-icons-png.flaticon.com/512/2256/2256920.png" }
                ],
                questions: [
        ...
        microLessons: [
            {
                ...
                title: 'Weekdays',
                slides: [
                    { venda: "Musumbuluwo", english: "Monday", context: "The first day of the work week.", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652191.png" },
                    { venda: "Ḽavhuvhili", english: "Tuesday", context: "The second day. 'Vhu-vhili' comes from the number two (mbili).", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652213.png" },
                    { venda: "Ḽavhuraru", english: "Wednesday", context: "Midweek. 'Vhu-raru' comes from the number three (raru).", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652243.png" },
                    { venda: "Ḽavhuṋa", english: "Thursday", context: "The fourth day. 'Vhu-ṋa' comes from the number four (iṋa).", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652267.png" },
                    { venda: "Ḽavhuṱanu", english: "Friday", context: "The last work day. 'Vhu-ṱanu' comes from the number five (ṱanu).", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652295.png" }
                ],
                questions: [
            ...
            },
            {
                ...
                title: 'Weekend',
                slides: [
                    { venda: "Mugivhibi", english: "Saturday", context: "The first day of the weekend.", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652320.png" },
                    { venda: "Swondaha", english: "Sunday", context: "A day for rest or church.", imageUrl: "https://cdn-icons-png.flaticon.com/512/3652/3652347.png" }
                ],
                questions: [
